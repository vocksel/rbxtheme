...
export const ROBLOX_VSCODE_THEME_MAP = {
    ...
    'Number Color': [ 'constant.numeric', 'constant' ],
    'String Color': [ 'string', 'string.quoted' ],
    'Comment Color': [ 'comment' ],
    'Bool Color': [ 'constant.language', 'constant' ],
    '"nil" Color': [ 'constant.language', 'constant' ],
    'Function Name Color': [ 'variable.function', 'entity.name.function' ],
    '"function" Color': [ 'keyword.control', 'variable.language', 'meta.function', 'keyword', 'variable' ],
    '"local" Color': ['keyword'],
    ...
    'Method Color': [ 'variable.function', 'entity.name.function' ],
